...
int main(int argc, char** argv)
{
    ...
    else
    {
        ...
        pr2_mocap_servoing::MocapServoingController controller(nh, std::string("right_arm"), arm_pose_topic, target_pose_topic, arm_config_topic, arm_command_action, kp, ki, kd);
        ROS_INFO("...startup complete");
        controller.Loop();
    }
    return 0;
